...
<body>
    <div class="container">
        <div class="header">
            <h1>Catálogo</h1>
            <a href="/livraria/livros/novo" class="btn btn-primary">+ Novo Livro</a>
        </div>
            ...
            <c:when test="${not empty livros}">
                <div class="book-grid">
                    <c:forEach var="livro" items="${livros}">
                        <div class="book-card">
                            <span class="book-id">Código #${livro.id}</span>
                            <h2 class="book-title">${livro.nomeLivro}</h2>
                            <p class="book-author">Por ${livro.autor}</p>
                            
                            <div class="book-details">
                                <div class="detail-item">
                                    <span class="detail-label">ISBN</span>
                                    <span class="detail-value">${livro.isbn}</span>
                                </div>
                                <div class="detail-item">
                                    <span class="detail-label">Publicação</span>
                                    <span class="detail-value">${livro.dataPublicacaoFormatada}</span>
                                </div>
                            </div>
                            
                            <span class="price-tag">R$ ${livro.valorLivroFormatado}</span>
                            
                            <div class="book-actions">
                                <a href="/livraria/livros/editar?id=${livro.id}" class="btn btn-outline">Editar</a>
                                <a href="/livraria/livros/deletar?id=${livro.id}" class="btn btn-danger" onclick="return confirm('Tem certeza que deseja excluir?')">Excluir</a>
                            </div>
                        </div>
                    </c:forEach>
                </div>
...
<body>
    ...
    <footer class="footer">
        <p>Trabalho Acadêmico • Alunos: Murilo Rocha, Pedro Henrique, Marcos Paulo</p>
        <a href="https://github.com/murilolol/fef" target="_blank">Repositório GitHub</a>
    </footer>
